...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeBreadCoinersed READ rangeBreadCoinersed WRITE setRangeBreadCoinersed)
...
public:
  ...
  */
  ...
  bool rangeBreadCoinersed() const { return mRangeBreadCoinersed; }
  ...
  void setRangeBreadCoinersed(bool reversed);
