...
/**
  BreadCoin GUI main class. This class represents the main window of the BreadCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BreadCoinGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit BreadCoinGUI(QWidget *parent = 0);
    ~BreadCoinGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a BreadCoin  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
