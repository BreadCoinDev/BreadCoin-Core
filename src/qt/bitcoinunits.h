...
/** BreadCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BreadCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BreadCoinUnits(QObject *parent);
...
typedef BreadCoinUnits::Unit BreadCoinUnit;
