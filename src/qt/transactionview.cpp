...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so BreadCoinUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(BreadCoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(BreadCoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(BreadCoinUnits::formatWithUnit(nDisplayUnit, amount, true, BreadCoinUnits::separatorAlways));
