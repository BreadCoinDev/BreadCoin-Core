 ...
 * The BreadCoin Developers 2018-2020
 */
...
BreadCoinGUI::BreadCoinGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("BreadCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("BreadCoin");
    setStyleSheet("#BreadCoin { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void BreadCoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BreadCoin address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About BreadCoin"), this);
    aboutAction->setToolTip(tr("Show information about BreadCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BreadCoin"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit BreadCoin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for BreadCoin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit BreadCoin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for BreadCoin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where BreadCoin data is stored"));
...
//void BreadCoinGUI::createMenuBar()
//{
//#ifdef Q_OS_MAC
...
void BreadCoinGUI::createToolBars()
{
...
void BreadCoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BreadCoin client") + QString(" ") + tr("[testnet]"));
...
void BreadCoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void BreadCoinGUI::setMessageModel(MessageModel *messageModel)
{
...
void BreadCoinGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("BreadCoin client"));
...
#ifndef Q_OS_MAC
void BreadCoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void BreadCoinGUI::optionsClicked()
{
...
void BreadCoinGUI::aboutClicked()
{
    AboutDialog dlg;
...
void BreadCoinGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void BreadCoinGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void BreadCoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BreadCoin network", "", count));
}

void BreadCoinGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void BreadCoinGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("BreadCoin") + " - ";
...
void BreadCoinGUI::error(const QString &title, const QString &message, bool modal)
{
...
void BreadCoinGUI::changeEvent(QEvent *e)
{
...
void BreadCoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void BreadCoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BreadCoinUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void BreadCoinGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(BreadCoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void BreadCoinGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void BreadCoinGUI::clearWidgets()
{
...
void BreadCoinGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#BreadCoin { background-image: url(:/images/background_light_alt); }");
}

void BreadCoinGUI::gotoBlockBrowser()
{
...
void BreadCoinGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#BreadCoin { background-image: url(:/images/background_light); }");
}

void BreadCoinGUI::gotoHistoryPage()
{
...
void BreadCoinGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void BreadCoinGUI::gotoAddressBookPage()
{
...
void BreadCoinGUI::gotoReceiveCoinsPage()
{
...
void BreadCoinGUI::gotoSendCoinsPage()
{
...
void BreadCoinGUI::gotoSignMessageTab(QString addr)
{
...
void BreadCoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void BreadCoinGUI::gotoMessagePage()
{
...
void BreadCoinGUI::gotoSettingsPage()
{
...
void BreadCoinGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void BreadCoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BreadCoin address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void BreadCoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void BreadCoinGUI::setWalletUnlockStakingOnly()
{
...
void BreadCoinGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void BreadCoinGUI::setEncryptionStatus(int status)
{
...
void BreadCoinGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void BreadCoinGUI::backupWallet()
{
...
void BreadCoinGUI::importPrivateKey()
{
...
void BreadCoinGUI::changePassphrase()
{
...
void BreadCoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void BreadCoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void BreadCoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void BreadCoinGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void BreadCoinGUI::updateStakingIcon()
{
    updateWeight();
...
void BreadCoinGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void BreadCoinGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void BreadCoinGUI::editConfigExt()
{
