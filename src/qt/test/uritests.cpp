...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseBreadCoinURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseBreadCoinURI("bitcoin://175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"));
    QVERIFY(rv.label == QString());
